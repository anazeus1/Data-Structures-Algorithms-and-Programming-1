...
//The abstract classes used in the declaration of DoublyLinkedList are replaced with appropriate interfaces.
implements Iterable<T>//The iterator is always provided via the same method,this means that doubly linkedList is iterable
{
    ...
    //The implementation of an interface by a class is forced by specifying implements insted of extends
    {
        Element current;
